...
class TariffPolicy
{
    ...
    {
        return $user->can('view_any_tariff');
    }
    ...
    {
        return $user->can('delete_any_tariff');
    }
     ...
     */
    public function replicate(User $user, Tariff $tariff): bool
    {
